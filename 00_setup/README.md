...
Open `03_deploy_streamlit_app.sql` in Snowflake Snowsight and run Steps 1-2 to create the database, schemas, and stages.
...
| `03_deliver/03b_dbt_generator_app.py` | `@GOVERNANCE.streamlit_apps` |
...
PUT file://03_deliver/03b_dbt_generator_app.py @RETAIL_BANKING_DB.GOVERNANCE.streamlit_apps AUTO_COMPRESS=FALSE;
```

### Step 3: Deploy Streamlit App

Run Steps 5-6 in `03_deploy_streamlit_app.sql` to create and verify the Streamlit app.
