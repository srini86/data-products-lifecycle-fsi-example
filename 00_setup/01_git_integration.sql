...
--
-- Repository: https://github.com/srini86/data-products-lifecycle-fsi-example
-- ============================================================================
...
CREATE OR REPLACE API INTEGRATION git_api_integration_public
  ...
  API_ALLOWED_PREFIXES = ('https://github.com/srini86/')
  ENABLED = TRUE
...
CREATE OR REPLACE GIT REPOSITORY data_products_repo
  ...
  ORIGIN = 'https://github.com/srini86/data-products-lifecycle-fsi-example.git'
